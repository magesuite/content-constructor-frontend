...
class ProductGridHeroRight implements DataProviderBlocksInterface
{
    public function getBlocks()
    {
        $blocks = [];
        $blocks[] = Index::getHeadlineBlock('Product Grid with right Hero');
        ...
        $blocks[] = [
            ...
            'data' => [
                ...
                'hero' => [
                    ...
                    'decoded_image' => '{{media url="creative_components/Layer_90.jpg"}}',
